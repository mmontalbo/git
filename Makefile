...
LIB_OBJS += abspath.o
LIB_OBJS += sequencer/add-interactive.o
LIB_OBJS += sequencer/add-patch.o
LIB_OBJS += advice.o
LIB_OBJS += setup/alias.o
LIB_OBJS += alloc.o
LIB_OBJS += sequencer/apply.o
...
LIB_OBJS += merge/fmt-merge-msg.o
LIB_OBJS += odb/fsck.o
...
LIB_OBJS += sequencer/mailinfo.o
LIB_OBJS += sequencer/mailmap.o
LIB_OBJS += odb/match-trees.o
LIB_OBJS += mem-pool.o
LIB_OBJS += merge/merge-blobs.o
LIB_OBJS += merge/merge-ll.o
LIB_OBJS += merge/merge-ort.o
LIB_OBJS += merge/merge-ort-wrappers.o
LIB_OBJS += merge/merge.o
...
LIB_OBJS += notes/notes-cache.o
LIB_OBJS += notes/notes-merge.o
LIB_OBJS += notes/notes-utils.o
LIB_OBJS += notes/notes.o
...
LIB_OBJS += sequencer/rebase-interactive.o
LIB_OBJS += sequencer/rebase.o
...
LIB_OBJS += submodule/submodule-config.o
LIB_OBJS += submodule/submodule.o
