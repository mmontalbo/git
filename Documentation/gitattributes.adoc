...
described below).  The process replies with "git-diff-server", the
version it supports, and the capabilities it supports.  It must select
...
The status packet reports the outcome:
