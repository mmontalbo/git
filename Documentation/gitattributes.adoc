...
A tool that also announces the `hunks-by-oid` capability may be asked
...
The tool answers in the same hunk-line form as below, or with
...
equivalent, including their trailing newlines.  A tool that cannot
